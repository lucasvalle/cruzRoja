				  ...
				  <div class="panel-body">
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6">
								...
								<small></small>
								<input validar type="text" required="required" min="5" max="7" pattern="^P[0-9]{5,7}" title="P000123" name="Placa" id="input" class="form-control" placeholder="Introduce la placa">
							</div>
							<div class="col-lg-6 col-md-6">
						...
						<div class="row">
							...
							<label for="">Año</label>
							<small></small>
								<input  validar type="text" name="Anio" id="input" class="form-control"  required="required" pattern="^[0-9]{2,4}" title="97 ó 1997">
							</div>
						</div>
