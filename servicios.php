...
$mes=date("m");
$serviciosMes->consultar("select * from servicioambulancia where month(Fecha)=$mes");
echo mysql_error();
?>
...
<div class="row">
	<div class="col-md-6 col-md-offset-6">
		<form action="servicios-srh" method="post">
			...
			<input type="search" name="dato" id="dato" class="form-control input-lg" value="" placeholder="Nombre del paciente" required="required" title="">
